    ...
    <div className=' p-6 bg-gray-100 rounded-lg'> 
      <div className="flex flex-col lg:flex-row gap-6 lg:gap-12">
        <div className='w-full'>
          <div className="flex items-center gap-2 mb-2"><span className='font-bold'>{dates}</span> <span className='text-gray-700'><IoLocationSharp /></span>  <span>{location}</span></div>
